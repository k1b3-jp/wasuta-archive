					...
					<div className="relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white before:to-transparent">
						{events.map((event, index) => {
							...
							return (
								...
								>
									<div
										className={`relative flex items-center justify-center w-10 h-10 rounded-full border border-white shadow shrink-0 md:order-1 md:-translate-x-1/2 ${color}`}
									>
									...
									{eventDate < today && (
										<div className="flex items-center justify-center absolute top-2 right-[250px] lg:right-[400px] text-[red] rounded-full border border-[red] w-20 h-20">
