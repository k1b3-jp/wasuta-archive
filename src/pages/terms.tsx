    ...
    <>
      <DefaultLayout>
        <div className="p-8">
          ...
          <h2 className="font-bold text-xl mb-3">第5条（禁止事項）</h2>
          <p className="mb-6">
          ...
          <h2 className="font-bold text-xl mb-3">第7条（著作権）</h2>
          <p className="mb-6">
          ...
          <h2 className="font-bold text-xl mb-3">第9条（退会）</h2>
          <p className="mb-6">
          ...
          <h2 className="font-bold text-xl mb-3">第12条（利用規約の変更）</h2>
          <p className="mb-6">
          ...
          <h2 className="font-bold text-xl mb-3">第13条（個人情報の取扱い）</h2>
          <p className="mb-6">
            当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。
          </p>
          <h2 className="font-bold text-xl mb-3">第14条（通知または連絡）</h2>
          <p className="mb-6">
          ...
          <h2 className="font-bold text-xl mb-3">第16条（準拠法・裁判管轄）</h2>
          <p className="mb-6">
