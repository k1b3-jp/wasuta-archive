    ...
    <>
      ...
      <DefaultLayout>
        <div className="p-8">
          ...
          <h2 className="font-bold text-xl mb-3">第2条（利用登録）</h2>
          <div className="mb-6">
            <ol>
              <li>
          ...
          <h2 className="font-bold text-xl mb-3">第3条（ユーザーIDおよびパスワードの管理）</h2>
          <div className="mb-6">
            <ol>
              <li>
          ...
          <div className="mb-6">
            ...
            <ol>
              ...
              <li>不正アクセスをし、またはこれを試みる行為 他のユーザーに成りすます行為</li>
              <li>
          ...
          <h2 className="font-bold text-xl mb-3">第5条（本サービスの提供の停止等）</h2>
          <div className="mb-6">
            <ol>
              <li>
          ...
          <h2 className="font-bold text-xl mb-3">第6条（著作権）</h2>
          <div className="mb-6">
            <ol>
              <li>
          ...
          <h2 className="font-bold text-xl mb-3">第7条（利用制限および登録抹消）</h2>
          <div className="mb-6">
            <ol>
              <li>
          ...
          <h2 className="font-bold text-xl mb-3">第8条（退会）</h2>
          <p className="mb-6">
            ユーザーは、運営者の定める退会手続により、本サービスから退会できるものとします。
          </p>
          <h2 className="font-bold text-xl mb-3">第9条（保証の否認および免責事項）</h2>
          <div className="mb-6">
            <ol>
              <li>
          ...
          <h2 className="font-bold text-xl mb-3">第10条（サービス内容の変更等）</h2>
          <p className="mb-6">
            運営者は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
          </p>
          <h2 className="font-bold text-xl mb-3">第11条（利用規約の変更）</h2>
          <div className="mb-6">
            <ol>
              <li>
          ...
          <h2 className="font-bold text-xl mb-3">第12条（個人情報の取扱い）</h2>
          <p className="mb-6">
          ...
          <h2 className="font-bold text-xl mb-3">第13条（通知または連絡）</h2>
          <p className="mb-6">
          ...
          <h2 className="font-bold text-xl mb-3">第14条（権利義務の譲渡の禁止）</h2>
          <p className="mb-6">
            ユーザーは、運営者の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
          </p>
          <h2 className="font-bold text-xl mb-3">第15条（準拠法・裁判管轄）</h2>
          <div className="mb-6">
            <ol>
